...
# jp_split <- cv_split %>% 
#   mutate(first_split = pmap(list(cv_split$splits[[1]]$data,
#                                  analysis_n,
#                                  assessment_n),
#          ~summarize(mean_sp_ed_fg = mean(sp_ed_fg),
#                     sped_p_analysis = mean_sp_ed_fg/analysis_n,
#                     sped_p_assessment = mean_sp_ed_fg/assessment_n)))
           

str(cv_split)
str(cv_split$splits[[1]]$data)

# d <- d %>% 
#   mutate(sped_p = )

# cv_split$splits[[1]]$data$sp_ed_fg == 'Y'
